...
<div id="id01" class="modal">
  <div class="modal-content animate" action="#">
    ...
    <div class="container-fluid">
      ...
      <button id="kakao"><img src="/web/resources/img/homeimg/main/kakao-login.png" alt="" width="100%"></button>  
      <label>
...
<!-- reservationjs -->
<script src="/web/resources/js/reservation/vendor/vanillacalendar.js"></script>
